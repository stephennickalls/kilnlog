    ...
    <div class="bg-white border border-parchment-3 rounded-2xl p-10 w-full max-w-md shadow-lg">
      ...
      <form class="flex flex-col gap-4" @submit.prevent="signUpEmail">
        <div class="flex flex-col gap-1.5">
          <label class="text-xs font-semibold uppercase tracking-widest text-ink-faint">Full name</label>
          <input
            v-model="name"
            type="text"
        ...
        <div v-if="success" class="text-sm text-green-700 bg-green-50 border border-green-200 rounded-lg px-3.5 py-2.5">
          {{ success }}
        </div>
