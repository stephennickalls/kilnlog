...
// firings has 11 columns; a list row needs 9 of them.
// OMITTED — and why:
...
export const FIRING_LIST_COLUMNS =
  'id, name, created_at, started_at, ended_at, paused_at, restarted_at, auto_ended, schedule_offset'
